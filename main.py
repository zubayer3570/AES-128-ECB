...
from state_creator import create_states_enc
...
def encryption(plainText, key):
    ...
    states = create_states_enc(plainText, "enc")
...
def decryption(cipherText, key):
    ...
    states = create_states_enc(cipherText, "dec")
